// Workbench Archetype - Hierarchical/raw data with curation capabilities
// GRIP Framework

export class AdaptiveWorkbench {
    constructor(dataUrl) {
...
export default AdaptiveWorkbench;
