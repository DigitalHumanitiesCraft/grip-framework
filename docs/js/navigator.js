// Adaptive Navigator - Force-Directed Graph from JSON
// GRIP Framework Demo
...
class AdaptiveNavigator {
    ...
    processData() {
        // Deep copy nodes with computed properties
    ...
    createGraph() {
        ...
        this.nodes.forEach(node => {
            ...
            // Node size based on in-degree (citations received)
    ...
    applyForces(width, height) {
        ...
        // Cluster force (nodes of same cluster attract slightly)
        ...
        if (this.currentLayout === 'radial') {
            ...
            visibleNodes.forEach(node => {
                ...
                // Distance based on connection to central node
