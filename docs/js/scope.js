// Adaptive Scope - Dynamic aggregation and visualization from survey data
...
class AdaptiveScope {
    ...
    renderKPIs() {
        ...
        const std = (arr, key) => {
            ...
            const variance = arr.reduce((sum, r) => sum + Math.pow(r[key] - mean, 2), 0) / arr.length;
...
document.addEventListener('DOMContentLoaded', () => {
    new AdaptiveScope('data/scope-survey.json');
});
